...
def parse_check_form(text):
    """فقط خط تاریخ رو جدا می‌کنه (چون برای یادآوری لازمه، مقدارش می‌تونه سرِ همون
    خط بعد از ':' باشه یا خط بعدی)؛ بقیه‌ی خط‌ها دست‌نخورده برای توضیح نگه داشته می‌شن."""
